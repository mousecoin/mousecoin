...
uint256 hashGenesisBlock("0xf9a531d730b3881da6b19d8dc7de224ba8307f298e3a68839b0c963fca542a44");
...
static const int64 nTargetTimespan = 0.0208 * 24 * 60 * 60; // Mousecoin: 0.35 days
static const int64 nTargetSpacing = 60; // Mousecoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal mousecoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x42ed67f063e7b9119621f89a5b5cd4bdb8359632794df6e7e72268b70c40237e");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Kanye sues Coinye";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389231377;   // 1389239721;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085950997;   // 2085408782;

        if (fTestNet)
        {
            block.nTime    = 1389231377;
            block.nNonce   = 386515667;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8cb5bd7d4b7e9c64af06b5ec6f647d416131f9f7a99b7c0b7dbf9c0cc60e1400"));
